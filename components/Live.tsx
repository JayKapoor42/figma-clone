...
const Live = ({ canvasRef, undo, redo }: Props) => {
  ...
  const handleContextMenuClick = useCallback((key: string) => {
    switch (key) {
      ...
      case "Text-to-Flowchart": // Adding a new case for opening the flowchart dialog
        setDialogOpen(true); // This will open the dialog box for input
        break;
    ...
    <ContextMenu>
      ...
      <DialogBox
          ...
          onSubmit={(inputText: string) => {
            console.log("Form Submitted: ", inputText); // Placeholder for actual submission logic
            // Here you would likely want to handle the input text, such as sending it to an API or processing it directly to generate a flowchart
